...
<div class="topbar">
    ...
    <a class="back" href="${pageContext.request.contextPath}/sysadmin/permissionManage">返回列表</a>
</div>

<form action="${pageContext.request.contextPath}/sysadmin/permissionManage/save" method="post">
