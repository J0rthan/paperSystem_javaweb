...
<form class="form-card"
      action="<%= request.getContextPath() %>/sysadmin/userManage/createAccount"
      method="post">
    ...
    <div>
        ...
        <input type="text" id="company" name="company" placeholder="请输入您的公司名" required>
    </div>

    <div>
        <label for="investigationDirection">就业方向</label>
        <input type="text" id="investigationDirection" name="investigationDirection"
               placeholder="请输入您的就业方向" required>
    </div>
